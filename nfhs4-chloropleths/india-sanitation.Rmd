---
title: "Households Using Improved Sanitation Facility in India (NFHS-4)"
output:
...
data$Sanitation<-data$Households.using.improved.sanitation.facility2
data$Sanitation<-data$Sanitation/100
data1 <- aggregate(Sanitation~State.1, data=data, FUN=mean)
```
...
data1$col <- sapply(data1$Sanitation, pickColor)
...
data$col <- sapply(data$Sanitation, pickColor)
