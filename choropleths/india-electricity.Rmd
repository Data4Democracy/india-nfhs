---
title: "Households With Electricity in India (NFHS-4)"
...
data$Electricity<-data$Households.with.electricity
data$Electricity<-data$Electricity/100
data1 <- aggregate(Electricity~State.1, data=data, FUN=mean)
```
...
data1$col <- sapply(data1$Electricity, pickColor)
...
data$col <- sapply(data$Electricity, pickColor)
